...
const navigationSettings = [
  ...
  { name: "Groups", href: siteConfig.baseLinks.settings.groups },
  { name: "Endpoints", href: siteConfig.baseLinks.settings.endpoints },
  { name: "Permissions", href: siteConfig.baseLinks.settings.permissions },
